...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            IBACoinGUI* window = static_cast<IBACoinGUI*>(parentWidget());
...
{
    IBACoinGUI* gui = static_cast<IBACoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<IBACoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("IBA Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your IBAs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
