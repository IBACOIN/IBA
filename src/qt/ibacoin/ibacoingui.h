...
#include "qt/ibacoin/navmenuwidget.h"
#include "qt/ibacoin/topbar.h"
#include "qt/ibacoin/dashboardwidget.h"
#include "qt/ibacoin/send.h"
#include "qt/ibacoin/receivewidget.h"
#include "qt/ibacoin/addresseswidget.h"
#include "qt/ibacoin/coldstakingwidget.h"
#include "qt/ibacoin/masternodeswidget.h"
#include "qt/ibacoin/snackbar.h"
#include "qt/ibacoin/settings/settingswidget.h"
...
/**
  IBACoin GUI main class. This class represents the main window of the IBACoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class IBACoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit IBACoinGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~IBACoinGUI();
