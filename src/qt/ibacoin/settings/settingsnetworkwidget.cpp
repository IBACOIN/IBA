...
#include "qt/ibacoin/settings/settingsnetworkwidget.h"
#include "qt/ibacoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ibacoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(IBACoinGUI* _window, QWidget *parent) :
