...
#include "qt/ibacoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>

SettingsExportCSV::SettingsExportCSV(IBACoinGUI* _window, QWidget* parent) : PWidget(_window, parent),
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
        ...
        isTxExport ? tr("IBACoin_tx_csv_export(*.csv)") : tr("IBACoin_addresses_csv_export(*.csv)"),
        nullptr);
