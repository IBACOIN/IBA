...
#include "qt/ibacoin/settings/settingsbackupwallet.h"
#include "qt/ibacoin/settings/settingsexportcsv.h"
#include "qt/ibacoin/settings/settingsbittoolwidget.h"
#include "qt/ibacoin/settings/settingssignmessagewidgets.h"
#include "qt/ibacoin/settings/settingswalletrepairwidget.h"
#include "qt/ibacoin/settings/settingswalletoptionswidget.h"
#include "qt/ibacoin/settings/settingsmainoptionswidget.h"
#include "qt/ibacoin/settings/settingsdisplayoptionswidget.h"
#include "qt/ibacoin/settings/settingsmultisendwidget.h"
#include "qt/ibacoin/settings/settingsinformationwidget.h"
#include "qt/ibacoin/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(IBACoinGUI* parent);
    ~SettingsWidget();
