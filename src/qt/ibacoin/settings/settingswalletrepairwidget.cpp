...
#include "qt/ibacoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ibacoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(IBACoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to IBACoinGUI::handleRestart()
