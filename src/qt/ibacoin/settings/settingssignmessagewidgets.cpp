...
#include "qt/ibacoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(IBACoinGUI* _window, QWidget *parent) :
