...
#include "qt/ibacoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/ibacoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(IBACoinGUI* _window, QWidget *parent) :
