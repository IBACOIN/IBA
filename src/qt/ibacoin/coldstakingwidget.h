...
#include "qt/ibacoin/furabstractlistitemdelegate.h"
#include "qt/ibacoin/txviewholder.h"
#include "qt/ibacoin/tooltipmenu.h"
#include "qt/ibacoin/sendmultirow.h"
#include "qt/ibacoin/coldstakingmodel.h"
#include "qt/ibacoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(IBACoinGUI* parent);
    ~ColdStakingWidget();
