...
#include "qt/ibacoin/sendcustomfeedialog.h"
#include "qt/ibacoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(IBACoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &IBACoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
