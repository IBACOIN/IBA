...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, IBACoinGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, IBACoinGUI* gui, double posX = 3);
