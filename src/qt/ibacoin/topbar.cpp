...
#include "qt/ibacoin/topbar.h"
#include "qt/ibacoin/forms/ui_topbar.h"
#include "qt/ibacoin/lockunlock.h"
#include "qt/ibacoin/qtutils.h"
#include "qt/ibacoin/receivedialog.h"
#include "qt/ibacoin/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/ibacoin/balancebubble.h"
...
TopBar::TopBar(IBACoinGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopIba, ui->labelAmountTopShieldedIba}, "amount-small-topbar");
    setCssProperty({ui->labelAmountIba}, "amount-topbar");
    setCssProperty({ui->labelPendingIba, ui->labelImmatureIba}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("IBACoin")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // IBA Total
    QString totalIba = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // IBA
    // Top
    ui->labelAmountTopIba->setText(totalTransparent);
    ui->labelAmountTopShieldedIba->setText(totalShielded);
    // Expanded
    ui->labelAmountIba->setText(totalIba);
    ui->labelPendingIba->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureIba->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
