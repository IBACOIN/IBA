...
/** Utility functions used by the IBACoin Qt UI.
 */
namespace GUIUtil
{
...
// Render IBACoin addresses in monospace font
...
// Parse "ibacoin:" URI into recipient object, return true on successful parsing
