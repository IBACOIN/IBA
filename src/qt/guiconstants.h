...
/* ibacoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "IBACoin"
#define QAPP_ORG_DOMAIN "ibacoin.org"
#define QAPP_APP_NAME_DEFAULT "IBACoin-Qt"
#define QAPP_APP_NAME_TESTNET "IBACoin-Qt-testnet"
