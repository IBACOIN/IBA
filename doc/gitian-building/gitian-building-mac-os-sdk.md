...
The script [extract-osx-sdk.sh](https://github.com/ibacoin-project/ibacoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
ibacoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/ibacoin-project/ibacoin/blob/master/doc/README_osx.md) for troubleshooting tips.
