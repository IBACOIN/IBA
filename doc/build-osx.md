...
1. Clone the IBA Coin source code:
        ...
        git clone https://github.com/ibacoin-project/ibacoin
        cd ibacoin
...
IBA Coin is now available at `./src/ibacoind`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/IBACoin"

    touch "/Users/${USER}/Library/Application Support/IBACoin/ibacoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/IBACoin/ibacoin.conf"

The first time you run ibacoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/IBACoin/debug.log

Other commands:
-------

    ./src/ibacoind -daemon # Starts the ibacoin daemon.
    ./src/ibacoin-cli --help # Outputs a list of command-line options.
    ./src/ibacoin-cli help # Outputs a list of RPC commands when the daemon is running.
