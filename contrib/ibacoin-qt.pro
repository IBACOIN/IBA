...
RESOURCES += src/qt/ibacoin.qrc src/qt/ibacoin_locale.qrc

TRANSLATIONS += src/qt/locale/ibacoin_bg.ts \
                src/qt/locale/ibacoin_de.ts \
                src/qt/locale/ibacoin_en.ts \
                src/qt/locale/ibacoin_es.ts \
                src/qt/locale/ibacoin_fi.ts \
                src/qt/locale/ibacoin_fr.ts \
                src/qt/locale/ibacoin_it.ts \
                src/qt/locale/ibacoin_ja.ts \
                src/qt/locale/ibacoin_pl.ts \
                src/qt/locale/ibacoin_pt.ts \
                src/qt/locale/ibacoin_ru.ts \
                src/qt/locale/ibacoin_sk.ts \
                src/qt/locale/ibacoin_sv.ts \
                src/qt/locale/ibacoin_vi.ts \
                src/qt/locale/ibacoin_zh_CN.ts \
                src/qt/locale/ibacoin_zh_TW.ts
