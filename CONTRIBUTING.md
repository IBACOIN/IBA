Contributing to IBA Coin
============================

The IBA Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ibacoin-project/ibacoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the IBA Coin project, and is not to be
confused with overall IBACoin Network Protocol consensus changes.

Whether a pull request is merged into IBA Coin rests with the project merge
...
Patches that change IBACoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the IBACoin consensus, it must have been
...
The project leader is the release manager for each IBA Coin release.
