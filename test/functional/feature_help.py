...
"""Verify that starting ibacoin with -h works as expected."""
import subprocess

from test_framework.test_framework import ibacoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ibacoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ibacoin with -? for help text")
        ...
        self.log.info("Start ibacoin with -version for version information")
