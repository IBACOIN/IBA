...
from test_framework.test_framework import ibacoinTier2TestFramework
...
class MasternodeGovernanceBasicTest(ibacoinTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.ibacoin.org/t/test-proposal"
