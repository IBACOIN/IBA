...
class ListReceivedTest (ibacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 IBA.
        ...
        # Send 1 IBA to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 IBA sending them all (fee is 0.1 IBA)
        ...
        # Confirm transaction (2 IBA from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 IBA, send 0.6 IBA + 0.05 IBA fee
