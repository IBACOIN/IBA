#!/usr/bin/env python3
# Copyright (c) 2020 The IBA Coin developers
...
class SaplingMempoolTest(ibacoinTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 IBA note to Alice
        ...
        # miner sends another 10 IBA note to Alice
