...
class BlockIndexStatsTest(ibacoinTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 IBA "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 IBA + 9 notes of 5 IBA + 1 note of 4 IBA (using 1.0 fee)
